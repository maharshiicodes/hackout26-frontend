...
type LogisticsRegisterFormState = {
  name: string;
  location: string;
  address: string;
  contactNum: string;
...
const initialFormState: LogisticsRegisterFormState = {
  name: "",
  location: "",
  address: "",
  contactNum: "",
...
export default function LogisticsRegisterComponent() {
  const router = useRouter();
  const [formState, setFormState] = useState<LogisticsRegisterFormState>(initialFormState);
  const [showPassword, setShowPassword] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [errorMessage, setErrorMessage] = useState("");

  function updateField<K extends keyof LogisticsRegisterFormState>(
    field: K,
    value: LogisticsRegisterFormState[K],
  ) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await apiClient.post("/api/logistics-companies/register", formState);
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="relative hidden w-1/2 min-h-screen overflow-hidden bg-black lg:block">
        <Image
          src="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-10">
          ...
          <div className="max-w-md">
            <h1 className="text-3xl font-semibold leading-tight text-white">
              Move captured CO2 where it needs to go.
            </h1>
            <p className="mt-3 text-sm leading-relaxed text-white/70">
              Register your logistics company to serve pincodes across the
              network and connect buyers with sellers of captured carbon.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col justify-center bg-white px-6 py-12 lg:w-1/2">
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-black/60">
            Create an account to manage serviceable pincodes and shipments.
          </p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="456 Logistics Park, Phase 2"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  placeholder="admin@expresslogistics.com"
